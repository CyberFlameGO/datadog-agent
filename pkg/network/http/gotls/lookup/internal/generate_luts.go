...
// - `func GetReadReturns(version goversion.GoVersion, goarch string) ([]bininspect.ParameterMetadata, error)`
...
type inspectionResult struct {
	...
	readReturns            []bininspect.ParameterMetadata
	...
	generator := &lutgen.LookupTableGenerator{
		...
		LookupFunctions: []lutgen.LookupFunction{
			...
			},
			{
				...
				OutputType:      "[]bininspect.ParameterMetadata",
				OutputZeroValue: "nil",
				DocComment:      `GetReadParams gets the return parameter metadata (positions/types) for crypto/tls.(*Conn).Read`,
				ExtractValue:    func(r interface{}) interface{} { return (r).(inspectionResult).readReturns },
			},
			{
				Name:            "GetCloseParams",
				OutputType:      "[]bininspect.ParameterMetadata",
