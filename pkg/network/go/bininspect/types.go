...
type FunctionConfig struct {
	...
	Name string
	// Whether to gather information about the return paths of the function
	// that can be used to attach a pseudo-uretprobe to each return path.
	IncludeReturn bool
}
...
type FunctionMetadata struct {
	...
	// True if the function metadata also includes information
	// needed to attach a probe to its return points.
	IncludesReturn bool
	// A list of parameter metadata structs
	// used for extracting the return values in the eBPF probe.
